package com.sunah.mini.utility

import com.sunah.mini.Url
import com.sunah.mini.response.search.SearchResponse
import com.sunah.mini.Key
...
interface ApiService {
    ...
    suspend fun getSearchLocation(
        ...
        @Query("count") count: Int = 20, //한페이지에 얼마씩 보여주는지
